...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'RectangleCopy3',
            type:'rect',
            rect:['-1px','4770px','100.1%','500px','auto','auto'],
            fill:["rgba(243,156,18,1.00)"],
            stroke:[0,"rgba(0,0,0,1)","none"]
         },
         {
         ...
         },
         {
            id:'effect10',
            type:'rect',
            rect:['17.1%','4987px','16.5%','auto','auto','auto']
         },
         {
            id:'effect10Copy',
            type:'rect',
            rect:['36.7%','4987px','16.5%','auto','auto','auto']
         },
         {
            id:'effect10Copy2',
            type:'rect',
            rect:['54.7%','4987px','16.5%','auto','auto','auto']
         },
         {
            id:'effect10Copy3',
            type:'rect',
            rect:['72.9%','4987px','16.5%','auto','auto','auto']
         }],
         symbolInstances: [
         {
            id:'effect4Copy2',
   ...
   states: {
      "Base State": {
         ...
         "${_RectangleCopy3}": [
            ["style", "top", '4770px'],
            ["style", "height", '500px'],
            ["color", "background-color", 'rgba(243,156,18,1)'],
            ["style", "left", '-1px'],
            ["style", "width", '100.09%']
         ],
         "${_effect2Copy2}": [
...
"effect10": {
   ...
   {
      rect: ['0px','0px','194px','41px','auto','auto'],
      font: ['source-sans-pro, sans-serif',36,'rgba(146,92,7,1.00)','300','none','normal'],
      userClass: 'effect10',
      id: 'Text2',
      text: 'Gannett',
      align: 'center',
   ...
   states: {
      "Base State": {
         "${_Text2}": [
            ["style", "top", '0px'],
            ["color", "color", 'rgba(146,92,7,1.00)'],
            ["style", "height", '41px'],
            ["style", "left", '0px'],
            ["style", "width", '194px']
         ],
